...
Scheme Based Speckle Reducing Nonlinear Diffusion'',  \emph{proceedings of SPIE Medical Imaging} (\textbf{SPIE MI}), 2009, Vol. 7259, 2009.\vspace{.05in}\\%\smallskip  
...
C/C++, Python, Java, Matlab, Bash, ITK, VTK, OPENCV, CUDA, MFC

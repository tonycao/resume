...
Developed a sparse representation based multi-modal registration algorithm. Extended the traditional image analogies method with sparse representation model, and applied this algorithm to the registration of Correlative Microscopy images.\vspace{.05in}
\\ %\smallskip 
